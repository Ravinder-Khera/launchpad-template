						...
						<div className="row align-items-center justify-content-between">
							<div className="col-lg-5">
								<div className="what-we-do-img">
									<img
										src="/launchpad-template/images/items/wedo.png"
										alt=""
						...
						<div className="row justify-content-center">
							<div className="col-auto">
								<div className="investor-brand">
									<img
										src="/launchpad-template/images/brand/b1.png"
										class="img-fluid"
										alt=""
									/>
								</div>
							...
							<div className="col-auto">
								<div className="investor-brand">
									<img
										src="/launchpad-template/images/brand/b2.png"
										class="img-fluid"
										alt=""
									/>
								</div>
							...
							<div className="col-auto">
								<div className="investor-brand">
									<img
										src="/launchpad-template/images/brand/b3.png"
										class="img-fluid"
										alt=""
									/>
								</div>
							...
							<div className="col-auto">
								<div className="investor-brand">
									<img
										src="/launchpad-template/images/brand/b4.png"
										class="img-fluid"
										alt=""
									/>
								</div>
							...
							<div className="col-auto">
								<div className="investor-brand">
									<img
										src="/launchpad-template/images/brand/b5.png"
										class="img-fluid"
										alt=""
									/>
								</div>
							...
							<div className="col-auto">
								<div className="investor-brand">
									<img
										src="/launchpad-template/images/brand/b6.png"
										class="img-fluid"
										alt=""
									/>
								</div>
							...
							<div className="col-auto">
								<div className="investor-brand">
									<img
										src="/launchpad-template/images/brand/b7.png"
										class="img-fluid"
										alt=""
									/>
								</div>
							...
							<div className="col-auto">
								<div className="investor-brand">
									<img
										src="/launchpad-template/images/brand/b8.png"
										class="img-fluid"
										alt=""
									/>
								</div>
							...
							<div className="col-auto">
								<div className="investor-brand">
									<img
										src="/launchpad-template/images/brand/b9.png"
										class="img-fluid"
										alt=""
									/>
								</div>
							...
							<div className="col-auto">
								<div className="investor-brand">
									<img
										src="/launchpad-template/images/brand/b10.png"
										class="img-fluid"
										alt=""
									/>
								</div>
